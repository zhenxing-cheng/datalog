package com.chengzhx.datalog.interceptor;
...
public class DataUpdateInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) {
        ...
        MappedStatement mappedStatement = handler.mappedStatement();
        ...
        if (SqlCommandType.UPDATE.equals(mappedStatement.getSqlCommandType())) {
            ...
            Class<?> entityType = Optional.ofNullable(tableInfo).isPresent() ? tableInfo.getEntityType() : null;
